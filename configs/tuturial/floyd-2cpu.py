...
process1.pid = 1100;
process1.cmd = ['tests/test-progs/polybench-c-4.2/floyd']

process2 = LiveProcess()
process2.pid = 1101;
process2.cmd = ['tests/test-progs/polybench-c-4.2/floyd']

process3 = LiveProcess()
process3.pid = 1103;
process3.cmd = ['tests/test-progs/polybench-c-4.2/floyd']
