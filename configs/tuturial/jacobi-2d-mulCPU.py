...
process1.pid = 1100;
process1.cmd = ['tests/test-progs/polybench-c-4.2/jacobi-2d2']
process2 = LiveProcess()
process2.pid = 1102;
process2.cmd = ['tests/test-progs/polybench-c-4.2/jacobi-2d0']
process3 = LiveProcess()
process3.pid = 1103;
process3.cmd = ['tests/test-progs/polybench-c-4.2/jacobi-2d3']
process4 = LiveProcess()
process4.pid = 1104;
process4.cmd = ['tests/test-progs/polybench-c-4.2/jacobi-2d1']
